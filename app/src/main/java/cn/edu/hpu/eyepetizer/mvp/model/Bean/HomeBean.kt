package cn.edu.hpu.eyepetizer.mvp.model.bean
...
data class HomeBean(var nextPageUrl: String?, var nextPublishTime: Long,
    ...
    data class IssueListBean(var releaseTime: Long, var type: String?,
                             var data: Long, var publishTime: Long,
        ...
        data class ItemListBean(var type: String?, var data: DataBean?, var tag: Any?) {
            data class DataBean(var dataType:String?,var id:Int,var title:String?,
                                ...
                                var adTrack:Any?,var isShade:Boolean,var label:Any?,
                                var labelList:Any?,var header:Any?,var category:String?,
                                var duration:Long?,var playUrl:String,var cover:CoverBean?,
                                var author:AuthorBean?,var releaseTime:Long?,var consumption:ConsumptionBean) {
